...
public class Box{
    ...
    //constructor - method that creates/initializes an instance of a class
    ...
    public static void main(String[] args){
        ...
        double v1 = b1.volume();
        System.out.println("The volume of box 1 is " + v1);
        double v2 = b2.volume();
        System.out.println("The volume of box 2 is " + v2);
